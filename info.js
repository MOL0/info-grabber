const Discord = require('v11-discord.js'); //le module est inclu dans le zip, évitez de le réinstaller car j'y ai apporté qlqs modifications (jsp comment upload un module/package)
